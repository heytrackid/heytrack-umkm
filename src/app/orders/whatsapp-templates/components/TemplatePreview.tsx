                    ...
                    <div className="space-y-4 overflow-y-auto pr-2 -mr-2">
                        ...
                        <div className="bg-gradient-to-b from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-3 shadow-md">
                            <div className="bg-white rounded-lg shadow-sm">
                                ...
                                {/* Message Bubble */}
                                <div className="p-3">
                                    <div className="bg-white border border-gray-200 rounded-lg rounded-tl-none p-2.5 shadow-sm max-h-64 overflow-y-auto">
                                                ...
                                                {varInfo && (
                                                    <div className="absolute bottom-full left-0 mb-2 hidden group-hover:block z-10 w-56">
                                                        <div className="bg-gray-900 text-white text-xs rounded-lg p-2 shadow-lg">
                                                            ...
                                                            <p className="text-gray-400 mt-0.5 text-xs">Contoh: {varInfo.example}</p>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
