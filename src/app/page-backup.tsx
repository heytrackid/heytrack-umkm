...
export default function Dashboard() {
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="p-6 bg-white/50 dark:bg-black/20 rounded-2xl backdrop-blur">
              <Calculator className="h-12 w-12 text-blue-600 mx-auto mb-4" />
              <h3 className="text-lg font-semibold mb-2">HPP Calculator</h3>
              <p className="text-sm text-muted-foreground">Hitung harga pokok produksi dengan akurat untuk semua produk kuliner</p>
            </div>
            <div className="p-6 bg-white/50 dark:bg-black/20 rounded-2xl backdrop-blur">
              <Package className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="text-lg font-semibold mb-2">Smart Inventory</h3>
              <p className="text-sm text-muted-foreground">Kelola stok bahan baku dengan sistem peringatan otomatis</p>
            </div>
            <div className="p-6 bg-white/50 dark:bg-black/20 rounded-2xl backdrop-blur">
              <BarChart3 className="h-12 w-12 text-purple-600 mx-auto mb-4" />
              <h3 className="text-lg font-semibold mb-2">Financial Analytics</h3>
              <p className="text-sm text-muted-foreground">Analisis keuntungan dan optimasi biaya operasional</p>
            </div>
          </div>
  ...
  // Show welcome page immediately for signed out users
  if (!userLoaded) {
