...
export type OperationalCost = OperationalCostsTable['Row']
export type OperationalCostInsert = OperationalCostsTable['Insert']
export type OperationalCostUpdate = OperationalCostsTable['Update']
