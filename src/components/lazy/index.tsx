...
export const preloadChartBundle = async () => {
  try {
    ...
    uiLogger.warn('Failed to preload chart bundle', { error: err })
  }
}
...
export const preloadTableBundle = async () => {
  try {
    ...
    uiLogger.warn('Failed to preload table bundle', { error: err })
  }
}
...
export const preloadModalComponent = async (modalType: string) => {
  try {
    ...
    uiLogger.warn('Failed to preload modal', { modalType, error: err })
  }
}
...
export const globalLazyLoadingUtils = {
  ...
  preloadAll: async () => {
    try {
      ...
      uiLogger.warn('Failed to preload all components', { error: err })
    }
  },
