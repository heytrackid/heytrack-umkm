...
export const StatCardPatterns = {
  ingredients: (stats: {
    ...
    },
    {
      ...
      variant: stats.lowStock > 0 ? 'destructive' : 'default' as any
    },
    {
      title: "Stok Habis",
      value: stats.outOfStock,
      description: "Bahan tidak tersedia",
      variant: stats.outOfStock > 0 ? 'destructive' : 'default' as any
    },
    {
      title: "Nilai Total",
  ...
  orders: (stats: {
    ...
    },
    {
      ...
      variant: stats.pending > 0 ? 'secondary' : 'default' as any
    },
    {
      title: "Selesai",
