...
export const INGREDIENT_UNITS = [
  ...
  { value: 'sack', label: 'Karung (sack)' },
  { value: 'carton', label: 'Karton (carton)' },
  { value: 'pack', label: 'Pak (pack)' },
  { value: 'ball', label: 'Bola (ball)' },
  { value: 'box', label: 'Kotak (box)' },
  { value: 'bag', label: 'Kantong (bag)' },
  { value: 'bottle', label: 'Botol (bottle)' },
  { value: 'can', label: 'Kaleng (can)' },
  { value: 'jar', label: 'Stoples (jar)' },
  { value: 'case', label: 'Kasus (case)' },
  { value: 'pallet', label: 'Palet (pallet)' },
  { value: 'roll', label: 'Gulungan (roll)' },
  { value: 'tube', label: 'Tabung (tube)' },
  { value: 'bundle', label: 'Ikatan (bundle)' },
  { value: 'crate', label: 'Krat (crate)' },
  { value: 'drum', label: 'Drum (drum)' },
  { value: 'sheet', label: 'Lembar (sheet)' },
  { value: 'reel', label: 'Reel (reel)' },
  { value: 'tin', label: 'Kalen (tin)' },
  { value: 'pot', label: 'Panci (pot)' },
  { value: 'tub', label: 'Wadah (tub)' },
  { value: 'pail', label: 'Ember (pail)' },
  { value: 'tray', label: 'Nampan (tray)' },
  { value: 'basket', label: 'Keranjang (basket)' },
  { value: 'sachet', label: 'Saset (sachet)' },
  { value: 'packet', label: 'Paket (packet)' },
  { value: 'portion', label: 'Porsi (portion)' },
  { value: 'serving', label: 'Porsi (serving)' },
] as const
