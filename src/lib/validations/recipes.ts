...
export const recipeSchema = z.object({
  ...
  serving_size: z.number().min(1, 'Porsi minimal 1').optional().nullable(),
  preparation_time: z.number().min(0, 'Waktu tidak boleh negatif').optional().nullable(),
  cooking_time: z.number().min(0, 'Waktu tidak boleh negatif').optional().nullable(),
