...
import type { Recipe as DBRecipe } from '@/types/database'

interface ItemsTabProps {
  orderItems: OrderItemWithRecipe[]
  availableRecipes: DBRecipe[]
  ...
  onRecipeSelect: (index: number, recipeId: string) => void
  onUpdateItem: <K extends keyof OrderItemWithRecipe>(
    index: number,
    field: K,
    ...
    <div className="space-y-4">
      ...
      {orderItems.length === 0 ? (
        <div className="text-center py-12">
          ...
          <Button type="button" onClick={handleAddItem} size="lg">
            <Plus className="h-4 w-4 mr-2" />
            Tambah Item Pertama
          </Button>
        </div>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <select
                          ...
                          onChange={(e: React.ChangeEvent<HTMLSelectElement>) => onRecipeSelect(index, e.target.value)}
                        >
