...
const App: React.FC = () => {
  ...
  const TabButton: React.FC<{ tabId: Tab; children: React.ReactNode }> = ({ tabId, children }) => (
    <button
      ...
      className={`relative px-6 py-4 md:px-8 font-semibold text-base md:text-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary rounded-t-lg ${
        activeTab === tabId
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 text-brand-dark font-sans">
      <Header />
